        ...
        <div class="author d-flex flex-wrap">
            <div class="col-6 mt-5">
                <div class="mt-5">
                    ...
                    <p class="editor">- The New York Times</p>
