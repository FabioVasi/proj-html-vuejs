                    ...
                    <div class="row g-5">
                        ...
                        <div class="col-4">
                            <div class="card text-white border-0 bg-transparent pe-3">
                                ...
                                <p style="color: #c6c4c4;" class="m-0">
                                    Lorem, ipsum dolor sit amet consectetur adipisicing elit. Recusandae ab veritatis iure quaerat fuga rem libero sequi! Animi ratione at eligendi, facere, iste similique ab eveniet facilis distinctio, iure ad.
                                </p>
                            </div>
                        </div>
                ...
                <div class="col-12">
                    <div class="card copyright pt-5 border-0 bg-transparent text-center">
                        <p class="m-0">
                            ...
                            Copyright 2012 - 2020 | Avada Theme by <a class="text-white text-decoration-none" href="#">Theme Fusion</a> | All Rights Reserved | Power by <a class="text-white text-decoration-none" href="#">WorldPress</a>
                        </p>
